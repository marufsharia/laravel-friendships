...
```php
composer require marufsharia/laravel-friendships
```

If you are using Laravel < 5.5, you need to add Marufsharia\Friendships\FriendshipsServiceProvider to your `config/app.php` providers array:
```php
Marufsharia\Friendships\FriendshipsServiceProvider::class,
```
Publish config and migrations
```
php artisan vendor:publish --provider="Marufsharia\Friendships\FriendshipsServiceProvider"
```
...
## Setup a Model
```php
use Marufsharia\Friendships\Traits\Friendable;
...
## How to use
[Check the Test file to see the package in action](https://github.com/marufsharia/laravel-friendships/blob/master/tests/FriendshipsTest.php)
